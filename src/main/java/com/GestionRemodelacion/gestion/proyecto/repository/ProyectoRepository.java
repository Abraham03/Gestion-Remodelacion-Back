...
public interface ProyectoRepository extends JpaRepository<Proyecto, Long> {
  ...
  Optional<Proyecto> findByNombreProyecto(String nombreProyecto);
    ...
    /**
     * ✅ CAMBIO: Consulta optimizada que devuelve directamente el DTO que necesitas.
     * Es más eficiente que traer la entidad completa y luego mapearla.
     */
    ...
    /**
     * ✅ NUEVO: Consulta para exportación que devuelve la entidad completa,
     * ya que el DTO de exportación necesita el objeto completo para mapear.
     */
